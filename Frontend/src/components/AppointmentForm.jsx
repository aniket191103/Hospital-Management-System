...
const AppointmentForm = () => {
  ...
  // State to manage the list of doctors fetched from the API
  const [doctors, setDoctors] = useState([]);

  // useEffect hook to fetch doctors when the component mounts
  useEffect(() => {
  ...
  // Handler function to submit the appointment form
  const handleAppointment = async (e) => {
    e.preventDefault();
    try {
      const hasVisitedBool = Boolean(hasVisited); // Convert checkbox value to boolean
  ...
  return (
    <div className="container form-component appointment-form">
      ...
      <form onSubmit={handleAppointment}>
        ...
        <button type="submit" style={{ margin: "0 auto", display: "block" }}>
          Get Appointment
        </button>
      </form>
    </div>
